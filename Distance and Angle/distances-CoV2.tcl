### Distance Calculations for SARS CoV-2 ###

set all [atomselect top "all"]
set ARBD [atomselect top "rbd1 and alpha"]
set ARBM [atomselect top "rbm1 and (resid 452 to 454 492 to 494) and alpha"]
set ANTD [atomselect top "ntd1 and alpha"]
set AS1 [atomselect top "s11 and alpha"]
set BRBD [atomselect top "rbd2 and alpha"]
set BRBM [atomselect top "rbm2 and alpha"]
set BNTD [atomselect top "ntd2 and alpha"]
set BS1 [atomselect top "s12 and alpha"]
set CRBD [atomselect top "rbd3 and alpha"]
set CRBM [atomselect top "rbm3 and alpha"]
set CNTD [atomselect top "ntd3 and alpha"]
set CS1 [atomselect top "s13 and alpha"]
set S2 [atomselect top "trimer and alpha"]
...
for {set frame 0} {$frame < $num_steps} {incr frame} {
    ...
    # Calculate the center of mass distance between different domains #
    ...
    # Calculate magnitudes of 3d COM distances
    set m1 [veclength $d1]
    set m2 [veclength $d2]
    set m3 [veclength $d3]
    set m4 [veclength $d4]
